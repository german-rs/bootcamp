...
let radiologia = [
    ...
    { hora: "16:30", especialista: "PATRICIA SUAZO", paciente: "RAMON ULLOA", rut:"14989389-K", prevision: "FONASA"}
...
document.getElementById("tablaTrauma").innerHTML = dataTrauma
...
document.getElementById("tablaDental").innerHTML = dataDental
...
document.getElementById("tablaRx").innerHTML = dataRx